...
function drawBarChartBarrasDif(dataset, action, div_id, element, margin, variable, barColor, textColor, textFontFamily, textFontWeight, textFontSize, labelLlarg, domainTime) {
    ...
    // Opción 1: Dibujar línea horizontal de la media global (ya existente)
    svg.append("line")
    ...
    // ---------------------------------------------------------------------------------
    // Opción 2: Dibujar línea de la media acumulada
    ...
    // ---------------------------------------------------------------------------------
    // Si no deseas la línea de puntos originales de los valores (que conectaban los datos
    // individuales), puedes comentar la siguiente sección.
    // Esta sección conectaba las barras directamente con un path lineal.
    // ---------------------------------------------------------------------------------

    // Si quieres mantener la línea original (que dibuja el mismo valor que las barras), 
